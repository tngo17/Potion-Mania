...
startButton.addEventListener("click", function() {
  window.location.href = "loadscreen.html"; // Replace "newpage.html" with the URL of the new page
});
...
delayPlay.addEventListener('click', function() {
    ...
    setTimeout(function() {
        window.location.href = "loadscreen.html"; // Replace with the URL of the new page
      }, 2000);  
});*/